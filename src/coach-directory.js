...
function render(host) {
  ...
  section.innerHTML = `
    ...
    <p class="dir-foot">Leagues still to research: Belgium, Scotland, Turkey, Austria, Switzerland, Greece, Denmark, plus English tiers 2 and 3 and the rest of MLS. This list grows every session rather than pretending to be complete.</p>`;
