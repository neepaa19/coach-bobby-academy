...
export const LEAGUES = [
  ...
  },
  {
    ...
    country: 'Netherlands',
    tier: 1,
    source: 'Wikipedia 2026/27 Eredivisie managerial changes table',
    confidence: 'Confirmed 2026/27 appointments only',
    note: 'The league personnel table was incomplete at the time of checking, so only clubs with a documented 2026/27 appointment are filled in. PSV and the rest are queued rather than guessed.',
    clubs: [
      ['AFC Ajax', 'Míchel'],
      ...
      ['SC Telstar', 'Henk Brugge'],
      ['FC Utrecht', 'Anthony Correia'],
      ['PSV Eindhoven', null],
      ['AZ Alkmaar', null],
      ['FC Twente', null],
      ['FC Groningen', null],
      ['Heracles Almelo', null],
      ['NEC Nijmegen', null],
      ['PEC Zwolle', null],
      ['Fortuna Sittard', null],
      ['NAC Breda', null],
      ['Excelsior', null],
      ['Willem II', null],
    ],
  },
  {
    ...
    country: 'Portugal',
    tier: 1,
    source: 'Wikipedia 2026/27 Primeira Liga managerial changes table',
    confidence: 'Confirmed 2026/27 appointments only; the source article is flagged as needing updates',
    note: 'Wikipedia itself flags this league page as incomplete, so I have taken only the entries with a dated appointment and left the rest open.',
    clubs: [
      ['SL Benfica', 'Marco Silva'],
      ['CD Nacional', 'João Gião'],
      ['Estrela da Amadora', 'Pepa'],
      ['Gil Vicente', 'Luís Pinto'],
      ['FC Porto', null],
      ['Sporting CP', null],
      ['SC Braga', null],
      ['Vitória de Guimarães', null],
      ['Estoril Praia', null],
      ['FC Alverca', null],
      ['Moreirense', null],
      ['Rio Ave', null],
  ...
  },
  {
    ...
    country: 'Scotland',
    tier: 1,
    source: 'Wikipedia 2026/27 Scottish Premiership managerial changes table',
    confidence: 'Confirmed 2026/27 appointments only',
    note: 'Derek McInnes appears against both Hearts and Rangers on 17 June 2026 in the source table — the coherent reading is that he left Hearts for Rangers, and Hearts then appointed Vrancken on 25 June. Recorded that way, and worth re-checking.',
    clubs: [
      ['Rangers', 'Derek McInnes'],
      ['Heart of Midlothian', 'Vrancken'],
  ...
  },
  {
    ...
    country: 'Belgium',
    tier: 1,
    source: 'Wikipedia 2026/27 Belgian Pro League managerial changes table',
    confidence: 'Confirmed 2026/27 appointments only',
    note: 'Royal Antwerp was recorded as vacant after Joseph Oosting left on 17 May 2026 — and Oosting turns up at Go Ahead Eagles in the Eredivisie, which is a useful cross-check that both entries are real.',
    clubs: [
      ['Zulte Waregem (Essevee)', 'Michael Beale'],
      ['OH Leuven', 'Timmy Simons'],
      ['SK Beveren', 'Tim Bakens'],
      ['RAAL La Louvière', 'Edward Still'],
      ['STVV Sint-Truiden', 'Frédéric De Meyer'],
      ['Royal Antwerp', null],
      ['Club Brugge', null],
      ['RSC Anderlecht', null],
      ['KRC Genk', null],
      ['Royal Union Saint-Gilloise', null],
      ['KAA Gent', null],
      ['Cercle Brugge', null],
      ['KV Mechelen', null],
      ['Standard Liège', null],
...
function render(host) {
  ...
  section.innerHTML = `
    ...
    <p class="dir-foot">Leagues still to research: Turkey, Austria, Switzerland, Greece, Denmark, plus English tiers 2 and 3 and the rest of MLS. This list grows every session rather than pretending to be complete.</p>`;
